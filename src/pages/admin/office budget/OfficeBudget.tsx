...
import { TableCols, tableData } from "@data/OfficeData";
  ...
  return (
    <>
      <div className="grid grid-cols-4 gap-4 mb-4" >
        ...
        <Card item={item} key={index} icon={<FaSackDollar/>}></Card>
        ))}
      </div>
      ...
      <div className="radius-container">
        ...
        <div style={{height:"calc(100vh - 409px)",overflowY:"auto"}}> <Table columns={TableCols}  dataSource={tableData}  /></div>
      </div>
    </>
  );
}
